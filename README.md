...
`npm test` собирает production-версию и проверяет основной сценарий, выдачу с одним и тремя вариантами, маленький запас, невозможный дедлайн, ближайший опоздавший маршрут, строгую точку отправления, валидацию времени, три сценария поддержки и нормализацию ответа MCP. Всего — 13 интеграционных проверок.
...
- карточки из фактических полей Туту: аэропорты и вокзалы, перевозчик, номер рейса/поезда, тариф, багаж, цена и исходная ссылка;

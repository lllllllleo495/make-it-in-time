...
5. на отдельном экране даёт проверенные контакты по исходному билету и короткий план действий.
...
`npm test` собирает production-версию и проверяет основной сценарий, выдачу с одним и тремя вариантами, маленький запас, невозможный дедлайн, ближайший опоздавший маршрут, строгую точку отправления, валидацию времени и отдельную выдачу контактов поддержки.

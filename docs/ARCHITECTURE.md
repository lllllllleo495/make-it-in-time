...
9. На четвёртом экране отдельный `POST /api/support` принимает сведения о сорванном рейсе и сопоставляет их с проверенным справочником. Эти данные не влияют на поиск билетов.
